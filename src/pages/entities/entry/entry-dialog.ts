...
export class EntryDialogPage {
    ...
    constructor(public navCtrl: NavController, public viewCtrl: ViewController, public toastCtrl: ToastController,
        ...
        this.form = formBuilder.group({
            ...
            title: [params.get('item') ? this.entry.title : null,  Validators.required],
            content: [params.get('item') ? this.entry.content : null,  Validators.required],
            date: [params.get('item') ? this.entry.date : null,  Validators.required],
